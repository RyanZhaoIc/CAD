...
def load_flower102(args):
    ...
    original_train = Flowers102(root='./data/FLOWER102',split='train',transform=test_transform,download=True)
    ...
    partial_training_dataset = flower102_partialize(original_train._image_files, partialY_matrix.float(), 
...
def flower102_partialize(images, given_partial_label_matrix, true_labels, images_diff, diff_targets):
...
def load_flower102_diff(args, diff_batch_size=8):
